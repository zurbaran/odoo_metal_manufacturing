...
class TestAutoJournalByCompany(TransactionCase):
    ...
    def test_auto_journal_sale_invoice(self):
        ...
        self.assertEqual(move.journal_id, self.journal_sale, "No se asignó correctamente el diario de ventas")
    ...
    def test_auto_journal_purchase_invoice(self):
        ...
        self.assertEqual(move.journal_id, self.journal_purchase, "No se asignó correctamente el diario de compras")
