...
class ProductBlueprintFormula(models.Model):
    ...
    _description = 'Fórmula del Producto'
    ...
    product_id = fields.Many2one('product.template', string='Producto', required=True)
    blueprint_id = fields.Many2one('product.blueprint', string='Plano', required=True, help="El plano al que pertenece esta fórmula.")
    ...
    font_size = fields.Float('Tamaño de la Fuente', default=12.0)
